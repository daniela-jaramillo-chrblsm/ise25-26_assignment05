Feature: Points of Sale Management
  ...
  Scenario: Update one of three existing POS
    Given the following POS exist
      ...
      | Schmelzpunkt        | Great waffles                    | CAFE            | ALTSTADT  | Hauptstraße     | 90           | 69117      | Heidelberg |
      | Bäcker Görtz        | Walking distance to lecture hall | BAKERY          | INF       | Berliner Str.   | 43           | 69120      | Heidelberg |
      | Vending Machine     | Only for emergencies             | VENDING_MACHINE | BERGHEIM  | Teststraße      | 99a          | 12345      | Other City |
    When I update the POS with name "Vending Machine" to have the description "Updated Vending Machine Description"
    Then the POS with name "Vending Machine" should have the description "Updated Vending Machine Description"
